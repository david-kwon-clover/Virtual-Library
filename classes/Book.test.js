...
describe("Book Tests", () => {
  ...
  test("Book static calculateAverageRating method returns the correct average ratings given an array of books", () => {
    const book1 = new Book(
      "To Kill a Mockingbird",
      1960,
      "Fiction",
    ...
    expect(Book.calculateAverageRating([book1, book2, book3])).toBe(3.9);
  });
});
