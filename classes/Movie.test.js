...
describe("Movie tests", () => {
  ...
  test("Movie static calculateAverageRating method returns the correct average ratings given an array of movies", () => {
    const movie1 = new Movie(
      "Inception",
      2010,
      "Sci-Fi",
    ...
    expect(Movie.calculateAverageRating(movies)).toBe(4.6);
  });
});
